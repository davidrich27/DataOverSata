...
public class ModelTestClient{
  public static void main(String[] args){
    ...
    model.addNewTrans(1, 1, 501, 1000.00, "University of Montana", "Initial Deposit", date, false);
    model.addNewTrans(2, 2, 601, 10000.00, "Unknown", "Secret Stash", date.minusDays(3), false);
    model.addNewTrans(2, 1, 401, 500.00, "Some Guy", "Owed a Dude 500 bucks", date.plusDays(5), true);
